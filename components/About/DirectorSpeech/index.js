              ...
              <div className='grid align-items-center'>
                <div className='col-12 lg:col-4'>
                  <div className='skrPhotoFrame'>
                    <Image src={author} alt='Sagor Konna Director' />
                  </div>
                </div>
                <div className='col-12 lg:col-8'>
                  <blockquote class='directorSpeechQuote'>
                    ...
                    is made up of primeval simplicity and antique grandeur.
                  </blockquote>
                  <div className='skrQuoteBottom'>
                    <div>
                      <h4 class=''>Emma Freeman</h4>
                      <p className='skrParagraphOnly'>Top Manager</p>
                    </div>
