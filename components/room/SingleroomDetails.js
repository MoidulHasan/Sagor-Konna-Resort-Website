...
const SingleroomDetails = ({ singleCard }) => {
    ...
    const itemTemplate = (card) => {
        return <img src={card} onError={(e) => e.target.src = 'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} alt={card} style={{ width: '100%', display: 'block' }} />
    }
        ...
        <div className="p-container">
            ...
            <div className="calender">
                ...
                <div className="field col-12 md:col-4">
                    ...
                    <Calendar id="checkout" value={checkout} onChange={(e) => setCheckout(e.value)} showIcon />
                </div>
            </div>
            <h5>Person</h5>
