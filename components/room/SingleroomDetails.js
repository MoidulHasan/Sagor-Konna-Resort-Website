...
const SingleroomDetails = ({ singleCard }) => {
  ...
  const itemTemplate = (card) => {
    return (
      <img
        className={`${singleRoom.gallary_view_img}`}
        src={card}
        onError={(e) =>
          (e.target.src =
  ...
  const thumbnailTemplate = (card) => {
    return (
      <img
        className={`${singleRoom.gallary_bottom_view_img}`}
        src={card}
        onError={(e) =>
          (e.target.src =
            'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png')
  ...
  return (
    <div className={`${singleRoom.singleroom_container}  grid  `}>
      <div
        className={`${singleRoom.singleroom_galleria_container} col lg:col-8`}
      >
        <Galleria
          className={`${singleRoom.singleroom_galleria}`}
          value={images}
      ...
      <div className={`${singleRoom.booking_details} col lg:col-4`}>
        ...
        <div className={`${singleRoom.booking}`}>
          ...
          <button className={`${singleRoom.reservation_btn}`}>
            Reservation
          </button>
        </div>
        ...
        <div className={`${singleRoom.people_count} grid`}>
          <div className={`${singleRoom.adult_count} lg:col-6`}>
            <h5>Person</h5>
            <Dropdown
              value={person}
              options={items}
          ...
          <div className={`${singleRoom.children_count} lg:col-6`}>
            <h5>Children</h5>
            <Dropdown
              value={children}
              options={items}
              onChange={countChildren}
              virtualScrollerOptions={{ itemSize: 38 }}
